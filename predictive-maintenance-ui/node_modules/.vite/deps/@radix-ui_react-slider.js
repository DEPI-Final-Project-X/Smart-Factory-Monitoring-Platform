...
var Slider = React12.forwardRef(
  (props, forwardedRef) => {
    ...
    const isKeyboardInteractionRef = React12.useRef(false);
...
function SliderThumbProvider(props) {
  ...
  return (0, import_jsx_runtime6.jsx)(SliderThumbContextProvider, { scope: __scopeSlider, ...thumbContext, children: isFunction2(internal_do_not_use_render) ? internal_do_not_use_render(thumbContext) : children });
}
SliderThumbProvider.displayName = THUMB_PROVIDER_NAME;
var THUMB_TRIGGER_NAME = "SliderThumbTrigger";
var SliderThumbTrigger = React12.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime6.jsx)(
      "span",
      {
        ...
        children: (0, import_jsx_runtime6.jsx)(Collection.ItemSlot, { scope: __scopeSlider, children: (0, import_jsx_runtime6.jsx)(
          Primitive.span,
          {
            role: "slider",
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime6.jsx)(
      SliderThumbProvider,
      {
        __scopeSlider,
        name,
        internal_do_not_use_render: ({ index, isFormControl }) => (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
